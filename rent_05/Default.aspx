0<%@ Page Title="Home Page" Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="rent_05._Default" %>
...
<!-- header -->
										...
										<div class="facts">
											<div class="register">
												<form id="signin" runat="server" method="post" >
                                                    <asp:TextBox ID="email" placeholder="Email Address" TextMode="Email" runat="server"></asp:TextBox>
													...
													<div class="sign-up">
														...
														<!--<input type="submit" name="submit" value="submit" Text="Sign in" />	-->
													</div>
                                                     <!--<a href="#">If you don't have account</a>-->
                                                    <asp:LinkButton ID="signup" runat="server">LinkButton</asp:LinkButton>
												</form>
											</div>
										</div> 
									</div>			        					            	      
	...
	<div class="header">
		<div class="container">
			...
			<div class="w3l_logo">
				<h1><a href="index.html">RentAway<span>Rent Your Wish</span></a></h1>
			</div>
			<div class="search">
...
<!-- banner -->
	<div class="banner" id="home1">
		<div class="container">
			<h3>RentAway, <span>style is eternal</span></h3>
		</div>
	</div>
<!-- //banner -->
							...
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs.320</span> <i class="item_price">Rs.250</i></p>
						...
						<div role="tabpanel" class="tab-pane fade" id="watches" aria-labelledby="watches-tab">
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs.320</span> <i class="item_price">Rs.150</i></p>
										<p><a class="item_add" href="#">Add to cart</a></p>
									</div>
								</div>
								<div class="col-md-4 agile_ecommerce_tab_left">
...
<!-- footer -->
	<div class="footer">
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>&copy; RentAway. All rights reserved | Design by team of Rentaway.</p>
			</div>
		</div>
	</div>
<!-- //footer -->
